...
class button_SongList(pygame.sprite.Sprite):
    selected = 1
    # Easy = 1 / Normal 2/ Hard 3/ Master 4
    def __init__(self, screen, button1_msg, button1_x, button1_y, button2_msg, button2_x, button2_y, button3_msg, button3_x, button3_y, button4_msg, button4_x, button4_y, action =None):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.Surface([30, 30])
