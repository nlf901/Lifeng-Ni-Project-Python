...
class Map(pygame.sprite.Sprite):
    ...
    def __init__(self, file, title, artist, level, highlight=0, album_art=None, screen=None):
        ...
        self.mode = 1 # Easy 1/ Normal 2/ Hard 3/ Master 4
        self.speed = 0
    ...
    def add_note_normal(self, type, sync_time, length = None):
        ...
        if length != None:
            self.Group_LongNote_Map_Length_Normal.append(length)
        else:
            self.Group_LongNote_Map_Length_Normal.append(0)
    ...
    def add_note_master(self, type, sync_time, length = None):
        ...
        if length != None:
            self.Group_LongNote_Map_Length_Master.append(length)
        else:
            self.Group_LongNote_Map_Length_Master.append(0)
